    ...
    <div className="min-h-screen bg-gradient-to-br from-white via-green-50 to-emerald-50">
      ...
      >
        <div className="max-w-4xl mx-auto relative z-10">
          <h1 className="text-6xl md:text-8xl font-bold text-emerald-800 mb-4 font-serif animate-fade-in-up">
      ...
      >
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-serif text-emerald-800 mb-4 animate-fade-in-up">
              Dónde
            </h2>
          ...
          <div className="grid md:grid-cols-2 gap-12 lg:gap-20">
            ...
            <div className="bg-white/90 backdrop-blur-sm rounded-3xl p-8 shadow-xl border border-green-100 transform hover:scale-105 transition-all duration-500 hover:shadow-2xl animate-slide-in-left">
              <div className="flex items-center gap-3 mb-6">
                ...
                <h3 className="text-2xl font-serif text-emerald-800">
                  Ceremonia
                </h3>
              </div>
        ...
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16">
            <div className="flex items-center justify-center gap-3 mb-4">
              ...
              <h2 className="text-4xl md:text-5xl font-serif text-emerald-800">
                Nuestra Historia
              </h2>
            </div>
            <div className="w-24 h-1 bg-gradient-to-r from-green-400 to-emerald-600 mx-auto animate-expand"></div>
      ...
      <footer className="py-12 text-center bg-emerald-800 text-white">
        <div className="max-w-4xl mx-auto px-4">
          ...
          <p className="text-green-200 mb-4 animate-fade-in-up delay-100">
            30 de Agosto, 2024
          </p>
          <div className="w-16 h-1 bg-gradient-to-r from-green-400 to-emerald-400 mx-auto animate-expand"></div>
          <p className="text-green-200 mt-6 animate-fade-in-up delay-200">
